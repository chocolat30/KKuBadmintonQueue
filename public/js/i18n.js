const translations = {
  en: {
    ...
    'queue-title-bar': 'Waiting Queue (Court ID: {n})',
    ...
    'undo-btn': 'Undo',
    'no-snapshot-left': 'No more snapshots to undo',
  ...
  th: {
    ...
    'queue-title-bar': 'คู่ที่กำลังต่อ (ไอดีคอร์ท: {n})',
    ...
    'undo-btn': 'ย้อนกลับ',
    'no-snapshot-left': 'ไม่สามารถย้อนกลับได้อีกแล้ว',
